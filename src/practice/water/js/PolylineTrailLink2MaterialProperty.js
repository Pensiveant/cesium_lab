function PolylineTrailLink2MaterialPropertyInit() {
  const repeat = 2;
  const MaterialPropertyType = "PolylineTrailLink2";
  ...
  PolylineTrailLink2MaterialProperty.prototype.getValue = function (
    time,
    result
  ) {
  ...
  Cesium.PolylineTrailLink2MaterialProperty =
    PolylineTrailLink2MaterialProperty;
  Cesium.Material.PolylineTrailLink2Type = MaterialPropertyType;
  Cesium.Material.PolylineTrailLink2Image = "./img/arrow1.png";
  Cesium.Material.PolylineTrailLink2Source =
  ...
  Cesium.Material._materialCache.addMaterial(
    Cesium.Material.PolylineTrailLink2Type,
    {
      fabric: {
...
export default PolylineTrailLink2MaterialPropertyInit;
