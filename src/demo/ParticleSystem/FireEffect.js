  ...
  init() {
    ...
    var particleSystem = this.scene.primitives.add(
      new Cesium.ParticleSystem({
        image: "./img/fire.png", //生成所需粒子的图片路径
        startColor: new Cesium.Color(1, 1, 1, 1), //粒子在生命周期开始时的颜色
        endColor: new Cesium.Color(0.5, 0, 0, 0), //粒子在生命周期结束时的颜色
        startScale: _this.viewModel.startScale, //粒子在生命周期开始时初始比例
        endScale: _this.viewModel.endScale, //粒子在生命周期结束时比例
        minimumParticleLife: _this.viewModel.minimumParticleLife, //粒子发射的最小速度
        maximumParticleLife: _this.viewModel.maximumParticleLife, //粒子发射的最大速度
        minimumSpeed: _this.viewModel.minimumSpeed,  //粒子质量的最小界限   
        maximumSpeed: _this.viewModel.maximumSpeed, //粒子质量的最大界限
        //以像素为单位缩放粒子图像尺寸
        imageSize: new Cesium.Cartesian2(
          _this.viewModel.particleSize,
          _this.viewModel.particleSize
        ),
        emissionRate: _this.viewModel.emissionRate,  //每秒发射的粒子数
